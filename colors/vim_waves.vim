...
if !(has('termguicolors') && &termguicolors) && !has('gui_running')
  ...
  echoerr '[Waves theme] There are not enough colors.'
  finish
endif
...
if &background ==# 'dark'
  let g:terminal_ansi_colors = [
        \ '#2c323b', '#d54e53', '#98c379', '#e5c07b', '#83a598', '#c678dd', '#288668', '#ebdbb2',
        \ '#242a32', '#ec3e45', '#90c966', '#edbf69', '#2bcec2', '#c858e9', '#2d9574', '#b2b2b2']
  if !has('gui_running') && get(g:, 'waves_transp_bg', 0)
    ...
    hi CursorLineNr ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi FoldColumn ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi Normal ctermfg=249 ctermbg=235 guifg=#b2b2b2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi CursorLineNr ctermfg=170 ctermbg=234 guifg=#c858e9 guibg=#212026 guisp=NONE cterm=NONE gui=NONE
    hi FoldColumn ctermfg=170 ctermbg=234 guifg=#c858e9 guibg=#212026 guisp=NONE cterm=NONE gui=NONE
    hi SignColumn ctermfg=249 ctermbg=235 guifg=#b2b2b2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi VertSplit ctermfg=234 ctermbg=235 guifg=#212026 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
  endif
  hi ColorColumn ctermfg=NONE ctermbg=234 guifg=NONE guibg=#212026 guisp=NONE cterm=NONE gui=NONE
  hi Conceal ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi DiffAdd ctermfg=70 ctermbg=235 guifg=#90c966 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffChange ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffDelete ctermfg=196 ctermbg=235 guifg=#ec3e45 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffText ctermfg=136 ctermbg=235 guifg=#edbf69 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Directory ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi EndOfBuffer ctermfg=235 ctermbg=NONE guifg=#2c323b guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Error ctermfg=196 ctermbg=235 guifg=#ec3e45 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ErrorMsg ctermfg=235 ctermbg=196 guifg=#2c323b guibg=#ec3e45 guisp=NONE cterm=NONE gui=NONE
  hi Folded ctermfg=133 ctermbg=234 guifg=#a45bad guibg=#212026 guisp=NONE cterm=NONE gui=NONE
  hi IncSearch ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi LineNr ctermfg=239 ctermbg=NONE guifg=#44505c guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi MatchParen ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
  ...
  hi Pmenu ctermfg=103 ctermbg=236 guifg=#9a9aba guibg=#242a32 guisp=NONE cterm=NONE gui=NONE
  ...
  hi Search ctermfg=70 ctermbg=235 guifg=#90c966 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi SpecialKey ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi SpellBad ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=#ec3e45 cterm=NONE,underline gui=NONE,undercurl
  hi SpellCap ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=#2bcec2 cterm=NONE,underline gui=NONE,undercurl
  hi SpellLocal ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=#2d9574 cterm=NONE,underline gui=NONE,undercurl
  hi SpellRare ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=#c858e9 cterm=NONE,underline gui=NONE,undercurl
  hi StatusLine ctermfg=249 ctermbg=60 guifg=#b2b2b2 guibg=#5d4d7a guisp=NONE cterm=NONE gui=NONE
  hi StatusLineNC ctermfg=60 ctermbg=236 guifg=#5d4d7a guibg=#242a32 guisp=NONE cterm=NONE gui=NONE
  hi! link StatusLineTerm StatusLine
  hi! link StatusLineTermNC StatusLineNC
  hi TabLineFill ctermfg=60 ctermbg=234 guifg=#544a65 guibg=#212026 guisp=NONE cterm=NONE gui=NONE
  hi TabLineSel ctermfg=70 ctermbg=234 guifg=#90c966 guibg=#212026 guisp=NONE cterm=NONE gui=NONE
  hi! link TabLine TabLineFill
  hi Title ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Visual ctermfg=NONE ctermbg=60 guifg=NONE guibg=#544a65 guisp=NONE cterm=NONE gui=NONE
  hi! link VisualNOS Visual
  hi WarningMsg ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Character ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Comment ctermfg=37 ctermbg=NONE guifg=#2aa1ae guibg=NONE guisp=NONE cterm=NONE,none gui=NONE,none
  hi Conditional ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Error ctermfg=196 ctermbg=235 guifg=#ec3e45 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Exception ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Float ctermfg=147 ctermbg=NONE guifg=#b7b7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Function ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Include ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Keyword ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Statement ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi StorageClass ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Typedef ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Underlined ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
  ...
  hi NormalMode ctermfg=240 ctermbg=235 guifg=#5b5b5b guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi InsertMode ctermfg=32 ctermbg=235 guifg=#2bcec2 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ReplaceMode ctermfg=29 ctermbg=235 guifg=#2d9574 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi VisualMode ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi CommandMode ctermfg=170 ctermbg=235 guifg=#c858e9 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Warnings ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#2c323b guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  if has('nvim')
    let g:terminal_color_0  = '#2c323b'
    let g:terminal_color_8  = '#44505c'
    let g:terminal_color_1  = '#d54e53'
    let g:terminal_color_9  = '#ec3e45'
    let g:terminal_color_2  = '#98c379'
    let g:terminal_color_10 = '#90c966'
    let g:terminal_color_3  = '#e5c07b'
    let g:terminal_color_11 = '#edbf69'
    let g:terminal_color_4  = '#83a598'
    let g:terminal_color_12 = '#2bcec2'
    let g:terminal_color_5  = '#c678dd'
    let g:terminal_color_13 = '#c858e9'
  ...
  if get(g:, "waves_plugin_hi_groups", 1)
    hi ALEError ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ec3e45 cterm=NONE,underline gui=NONE,undercurl
    hi ALEWarning ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ec3e45 cterm=NONE,underline gui=NONE,undercurl
    hi ALEInfo ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#2bcec2 cterm=NONE,underline gui=NONE,undercurl
    hi ALEErrorSign ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi ALEWarningSign ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi ALEInfoSign ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi BufTabLineCurrent ctermfg=235 ctermbg=240 guifg=#2c323b guibg=#5b5b5b guisp=NONE cterm=NONE gui=NONE
    hi BufTabLineActive ctermfg=240 ctermbg=232 guifg=#5b5b5b guibg=#100a14 guisp=NONE cterm=NONE gui=NONE
    hi BufTabLineHidden ctermfg=236 ctermbg=234 guifg=#242a32 guibg=#212026 guisp=NONE cterm=NONE gui=NONE
    hi BufTabLineFill ctermfg=235 ctermbg=235 guifg=#2c323b guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi CtrlPMatch ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPNoEntries ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPPrtBase ctermfg=232 ctermbg=NONE guifg=#100a14 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPPrtCursor ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPLinePre ctermfg=232 ctermbg=NONE guifg=#100a14 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPMode1 ctermfg=32 ctermbg=232 guifg=#2bcec2 guibg=#100a14 guisp=NONE cterm=NONE gui=NONE
    hi CtrlPMode2 ctermfg=235 ctermbg=32 guifg=#2c323b guibg=#2bcec2 guisp=NONE cterm=NONE gui=NONE
    ...
    hi DirvishArg ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link EasyMotionTarget Search
    hi! link EasyMotionShade Comment
    hi gitcommitSelectedFile ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi gitcommitDiscardedFile ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi GitGutterAdd ctermfg=70 ctermbg=235 guifg=#90c966 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi GitGutterChange ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi GitGutterDelete ctermfg=196 ctermbg=235 guifg=#ec3e45 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi GitGutterChangeDelete ctermfg=168 ctermbg=235 guifg=#ce537a guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    if get(g:, "indent_guides_auto_colors", 0)
      if get(g:, "waves_invert_indent_guides", 0)
        hi IndentGuidesOdd ctermfg=235 ctermbg=232 guifg=#2c323b guibg=#100a14 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
        hi IndentGuidesEven ctermfg=235 ctermbg=234 guifg=#2c323b guibg=#212026 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
      else
        hi IndentGuidesOdd ctermfg=235 ctermbg=232 guifg=#2c323b guibg=#100a14 guisp=NONE cterm=NONE gui=NONE
        hi IndentGuidesEven ctermfg=235 ctermbg=234 guifg=#2c323b guibg=#212026 guisp=NONE cterm=NONE gui=NONE
      endif
    endif
    " IndentLine
    ...
    hi NERDTreeDir ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeDirSlash ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeOpenable ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeClosable ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeFile ctermfg=249 ctermbg=NONE guifg=#b2b2b2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeExecFile ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeUp ctermfg=168 ctermbg=NONE guifg=#ce537a guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeCWD ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeHelp ctermfg=249 ctermbg=NONE guifg=#b2b2b2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeToggleOn ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeToggleOff ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwDir ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwClassify ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi netrwExe ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwComment ctermfg=239 ctermbg=NONE guifg=#44505c guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwList ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwHelpCmd ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwCmdSep ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwVersion ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    " Rainbow Parentheses
    if !exists('g:rbpt_colorpairs')
      let g:rbpt_colorpairs = [['blue', '#83a598'], ['magenta', '#c678dd'],
            \ ['red', '#d54e53'], ['173', '#ca754b']]
    endif

    let g:rainbow_guifgs = [ '#ca754b', '#d54e53', '#c678dd', '#83a598' ]
    ...
    hi ShowMarksHLl ctermfg=32 ctermbg=235 guifg=#2bcec2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi ShowMarksHLu ctermfg=32 ctermbg=235 guifg=#2bcec2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi ShowMarksHLo ctermfg=32 ctermbg=235 guifg=#2bcec2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi ShowMarksHLm ctermfg=32 ctermbg=235 guifg=#2bcec2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi SignifySignAdd ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignifySignChange ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignifySignDelete ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignatureMarkText ctermfg=32 ctermbg=235 guifg=#2bcec2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi SignatureMarkerText ctermfg=170 ctermbg=235 guifg=#c858e9 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi StartifyBracket ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifyFile ctermfg=249 ctermbg=235 guifg=#b2b2b2 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi StartifyNumber ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifyPath ctermfg=68 ctermbg=NONE guifg=#7590db guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifySlash ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifySection ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi SyntasticError ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ec3e45 cterm=NONE,underline gui=NONE,undercurl
    hi SyntasticWarning ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#edbf69 cterm=NONE,underline gui=NONE,undercurl
    hi SyntasticErrorSign ctermfg=196 ctermbg=235 guifg=#ec3e45 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi SyntasticWarningSign ctermfg=136 ctermbg=235 guifg=#edbf69 guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    ...
    hi WhichKeySeperator ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link WhichKeyGroup Keyword
    hi! link WhichKeyDesc Identifier
    let g:vimshell_escape_colors = [
          \ '#242a32', '#ec3e45', '#90c966', '#edbf69',
          \ '#2bcec2', '#c858e9', '#2d9574', '#5b5b5b',
          \ '#2c323b', '#ec3e45', '#90c966', '#e18254',
          \ '#2bcec2', '#c858e9', '#2d9574', '#cdcdcd'
          \ ]
  endif
  if get(g:, "waves_filetype_hi_groups", 1)
    hi diffAdded ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffRemoved ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi diffNewFile ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffLine ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlTag ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlEndTag ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi htmlScriptTag ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi htmlLink ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
    hi htmlSpecialChar ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlBold ctermfg=fg ctermbg=235 guifg=fg guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi htmlBoldUnderline ctermfg=fg ctermbg=235 guifg=fg guibg=#2c323b guisp=NONE cterm=NONE,underline gui=NONE,underline
    hi htmlBoldItalic ctermfg=fg ctermbg=235 guifg=fg guibg=#2c323b guisp=NONE cterm=NONE gui=NONE
    hi htmlBoldUnderlineItalic ctermfg=fg ctermbg=235 guifg=fg guibg=#2c323b guisp=NONE cterm=NONE,underline gui=NONE,underline
    hi htmlUnderline ctermfg=fg ctermbg=235 guifg=fg guibg=#2c323b guisp=NONE cterm=NONE,underline gui=NONE,underline
    hi htmlUnderlineItalic ctermfg=fg ctermbg=235 guifg=fg guibg=#2c323b guisp=NONE cterm=NONE,underline gui=NONE,underline
    hi htmlItalic ctermfg=68 ctermbg=NONE guifg=#7590db guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlTag ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlEndTag ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlTagName ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlEqual ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi xmlDocTypeKeyword ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlCdataStart ctermfg=239 ctermbg=NONE guifg=#44505c guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlCdataCdata ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi dtdFunction ctermfg=239 ctermbg=NONE guifg=#44505c guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi dtdTagName ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi vimCommand ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi vimLet ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi vimNorm ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi vimSetSep ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi vimSep ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi vimContinue ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureKeyword ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi clojureFunc ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureRepeat ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi clojureException ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi clojureRegexpCharClass ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link clojureRegexpMod clojureRegexpCharClass
    hi! link clojureRegexpQuantifier clojureRegexpCharClass
    hi clojureParen ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureAnonArg ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureVariable ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureMacro ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureMeta ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureDeref ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureQuote ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureUnquote ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cOperator ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cStructure ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi rustSelf ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi cssBraces ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssFunctionName ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssIdentifier ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssClassName ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssColor ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssSelectorOp ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssSelectorOp2 ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssImportant ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi cssUIProp ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi cssPositioningProp ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javaScriptIdentifier ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptMember ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptNumber ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptNull ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptParens ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javascriptClassName ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptClassSuperName ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptGlobal ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javascriptArrowFunc ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsExportDefault ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsNull ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link jsUndefined ErrorMsg
    hi jsClassDefinition ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsFuncArgs ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsStorageClass ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsxRegion ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi typeScriptNull ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi coffeeExtendedOp ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi coffeeSpecialOp ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi coffeeCurly ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi coffeeParen ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi coffeeBracket ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi rubyStringDelimiter ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi rubyInterpolationDelimiter ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi objcTypeModifier ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi objcDirective ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi goDirective ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi goConstants ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link goDeclaration Keyword
    hi goDeclType ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi moonSpecialOp ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi moonExtendedOp ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi moonFunction ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi moonObject ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaAnnotation ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaDocTags ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link javaCommentTitle vimCommentTitle
    hi javaParen ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaParen1 ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaParen2 ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaParen3 ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaParen4 ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaParen5 ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaOperator ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaVarArg ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link elixirDocString Comment
    hi elixirStringDelimiter ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi elixirInterpolationDelimiter ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi elixirModuleDeclaration ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi scalaTypeDeclaration ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaTypeTypePostDeclaration ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi markdownItalic ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH1 ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH2 ctermfg=29 ctermbg=NONE guifg=#2d9574 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH3 ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH4 ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH5 ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH6 ctermfg=136 ctermbg=NONE guifg=#edbf69 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi markdownUrlDelimiter ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownLinkDelimiter ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownLinkTextDelimiter ctermfg=243 ctermbg=NONE guifg=#ebdbb2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownHeadingDelimiter ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownUrl ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownUrlTitleDelimiter ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi haskellOperators ctermfg=32 ctermbg=NONE guifg=#2bcec2 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi haskellNumber ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellPragma ctermfg=170 ctermbg=NONE guifg=#c858e9 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellString ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellChar ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsonKeyword ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsonQuote ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
let g:terminal_ansi_colors = [
      \ '#fbf8ef', '#d54e53', '#98c379', '#e5c07b', '#83a598', '#c678dd', '#288668', '#504259',
      \ '#a8a4ae', '#ec3e45', '#90c966', '#edbf69', '#3a81c3', '#6c3163', '#24775c', '#655370']
if !has('gui_running') && get(g:, 'waves_transp_bg', 0)
...
hi DiffAdd ctermfg=70 ctermbg=231 guifg=#90c966 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffChange ctermfg=166 ctermbg=231 guifg=#b46843 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffDelete ctermfg=196 ctermbg=231 guifg=#ec3e45 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffText ctermfg=136 ctermbg=231 guifg=#edbf69 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi Error ctermfg=196 ctermbg=231 guifg=#ec3e45 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ErrorMsg ctermfg=231 ctermbg=196 guifg=#fbf8ef guibg=#ec3e45 guisp=NONE cterm=NONE gui=NONE
...
hi! link QuickFixLine Search
hi! link qfLineNr Type
hi Search ctermfg=70 ctermbg=231 guifg=#90c966 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi TabLineSel ctermfg=70 ctermbg=255 guifg=#90c966 guibg=#efeae9 guisp=NONE cterm=NONE gui=NONE
hi! link TabLine TabLineFill
hi Title ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Visual ctermfg=NONE ctermbg=60 guifg=NONE guibg=#544a65 guisp=NONE cterm=NONE gui=NONE
hi! link VisualNOS Visual
...
if get(g:, "waves_plugin_hi_groups", 1)
  ...
  hi gitcommitSelectedFile ctermfg=70 ctermbg=NONE guifg=#90c966 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi gitcommitDiscardedFile ctermfg=196 ctermbg=NONE guifg=#ec3e45 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi GitGutterAdd ctermfg=70 ctermbg=231 guifg=#90c966 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi GitGutterChange ctermfg=166 ctermbg=231 guifg=#b46843 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi GitGutterDelete ctermfg=196 ctermbg=231 guifg=#ec3e45 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  ...
  hi SyntasticError ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ec3e45 cterm=NONE,underline gui=NONE,undercurl
  hi SyntasticWarning ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#edbf69 cterm=NONE,underline gui=NONE,undercurl
  hi SyntasticErrorSign ctermfg=196 ctermbg=231 guifg=#ec3e45 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi SyntasticWarningSign ctermfg=136 ctermbg=231 guifg=#edbf69 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi multiple_cursors_cursor ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi! link WhichKeyDesc Identifier
  let g:vimshell_escape_colors = [
        \ '#a8a4ae', '#ec3e45', '#90c966', '#edbf69',
        \ '#3a81c3', '#6c3163', '#24775c', '#463a4e',
        \ '#fbf8ef', '#ec3e45', '#90c966', '#b46843',
...
" Color: neutralred        #d54e53    ~
" Color: neutralgreen      #98c379    ~
" Color: neutralyellow     #e5c07b    ~
" Color: neutralblue       #83a598    ~
" Color: neutralpurple     #c678dd    ~
