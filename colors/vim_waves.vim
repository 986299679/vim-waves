" Name:         Waves
" Description:  Dark theme inspired by snazzy, and enhancement for snazzy.
" Author:       Waves[986299679@github.com]
" Maintainer:   Waves[986299679@github.com]
" Website:      https://github.com/986299679/vim-waves
" License:      Vim License (see `:help license`)
" Last Updated: Mon 25 Mar 2019 05:22:40 PM CST

if !(has('termguicolors') && &termguicolors) && !has('gui_running')
      \ && (!exists('&t_Co') || &t_Co < 256)
  echoerr '[Waves] There are not enough colors.'
  finish
endif
...
if &background ==# 'dark'
  let g:terminal_ansi_colors = [
        \ '#282a36', '#d26487', '#4be67e', '#f3f99d', '#46baff', '#a15ea7', '#49C773', '#727272',
        \ '#34323e', '#ff5c57', '#5af78e', '#f7ff81', '#67c7ff', '#bc6ec5', '#e6005f', '#ffffff']
  if !has('gui_running') && get(g:, 'waves_transp_bg', 0)
    hi Normal ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CursorLineNr ctermfg=170 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi FoldColumn ctermfg=170 ctermbg=NONE guifg=#bc6ec5 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignColumn ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi VertSplit ctermfg=234 ctermbg=NONE guifg=#212026 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  else
    hi Normal ctermfg=249 ctermbg=235 guifg=#ffffff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    ...
    hi SignColumn ctermfg=249 ctermbg=235 guifg=#ffffff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
  ...
  hi Conceal ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Cursor ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi! link CursorColumn CursorLine
  hi CursorLine ctermfg=NONE ctermbg=234 guifg=NONE guibg=#3a3d4d guisp=NONE cterm=NONE gui=NONE
  hi DiffAdd ctermfg=70 ctermbg=235 guifg=#5af78e guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffChange ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffDelete ctermfg=196 ctermbg=235 guifg=#ff5c57 guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi DiffText ctermfg=136 ctermbg=235 guifg=#f7ff81 guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Directory ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi EndOfBuffer ctermfg=235 ctermbg=NONE guifg=#282a36 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Error ctermfg=196 ctermbg=235 guifg=#ff5c57 guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ErrorMsg ctermfg=235 ctermbg=196 guifg=#282a36 guibg=#ff5c57 guisp=NONE cterm=NONE gui=NONE
  ...
  hi MatchParen ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
  ...
  hi Pmenu ctermfg=255 ctermbg=239 guifg=#eff0eb guibg=#3a3d4d guisp=#3a3d4d cterm=NONE gui=NONE
  hi PmenuSbar ctermfg=NONE ctermbg=102 guifg=NONE guibg=#848688 guisp=#848688 cterm=NONE gui=NONE
  hi PmenuSel ctermfg=84 ctermbg=239 guifg=#5af78e guibg=#3a3d4d guisp=#3a3d4d cterm=NONE gui=NONE
  hi PmenuThumb ctermfg=NONE ctermbg=248 guifg=NONE guibg=#a1a6a8 guisp=#a1a6a8 cterm=NONE gui=NONE
  hi Question ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi! link QuickFixLine Search
  hi! link qfLineNr Type
  hi Search ctermfg=70 ctermbg=235 guifg=#5af78e guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi SpecialKey ctermfg=170 ctermbg=NONE guifg=#bc6ec5 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi SpellBad ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=#ff5c57 cterm=NONE,underline gui=NONE,undercurl
  hi SpellCap ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=#67c7ff cterm=NONE,underline gui=NONE,undercurl
  hi SpellLocal ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=#e6005f cterm=NONE,underline gui=NONE,undercurl
  hi SpellRare ctermfg=170 ctermbg=NONE guifg=#bc6ec5 guibg=NONE guisp=#bc6ec5 cterm=NONE,underline gui=NONE,undercurl
  hi StatusLine ctermfg=249 ctermbg=60 guifg=#ffffff guibg=#5d4d7a guisp=NONE cterm=NONE gui=NONE
  ...
  hi TabLineSel ctermfg=70 ctermbg=234 guifg=#5af78e guibg=#212026 guisp=NONE cterm=NONE gui=NONE
  hi! link TabLine TabLineFill
  hi Title ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Visual ctermfg=NONE ctermbg=60 guifg=NONE guibg=#3a3d4d guisp=NONE cterm=NONE gui=NONE
  hi! link VisualNOS Visual
  hi WarningMsg ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Define ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Error ctermfg=196 ctermbg=235 guifg=#ff5c57 guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi Exception ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Identifier ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Macro ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Statement ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi StorageClass ctermfg=136 ctermbg=NONE guifg=#57c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Special ctermfg=172 ctermbg=NONE guifg=#d79650 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi String ctermfg=29 ctermbg=NONE guifg=#f3ff9d guibg=NONE guisp=NONE cterm=NONE gui=NONE
  "hi String ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
  ...
  hi Type ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Typedef ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi Underlined ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
  ...
  if get(g:, "waves_italicize_strings", 0)
  ...
  hi InsertMode ctermfg=32 ctermbg=235 guifg=#67c7ff guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  hi ReplaceMode ctermfg=29 ctermbg=235 guifg=#e6005f guibg=#282a36 guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  if has('nvim')
    ...
    let g:terminal_color_2  = '#4be67e'
    let g:terminal_color_10 = '#5af78e'
    let g:terminal_color_3  = '#f3f99d'
    let g:terminal_color_11 = '#f7ff81'
    let g:terminal_color_4  = '#46baff'
    let g:terminal_color_12 = '#67c7ff'
    let g:terminal_color_5  = '#a15ea7'
    let g:terminal_color_13 = '#bc6ec5'
    let g:terminal_color_6  = '#49C773'
    let g:terminal_color_14 = '#e6005f'
    let g:terminal_color_7  = '#5b5b5b'
    let g:terminal_color_15 = '#ffffff'
    hi! link TermCursor Cursor
    hi TermCursorNC ctermfg=234 ctermbg=249 guifg=#212026 guibg=#ffffff guisp=NONE cterm=NONE gui=NONE
  endif
  if !(get(g:, "waves_plugin_hi_groups", 1) || get(g:, "waves_filetype_hi_groups", 1))
    finish
  endif
  if get(g:, "waves_plugin_hi_groups", 1)
    hi ALEError ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ff5c57 cterm=NONE,underline gui=NONE,undercurl
    hi ALEWarning ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ff5c57 cterm=NONE,underline gui=NONE,undercurl
    hi ALEInfo ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#67c7ff cterm=NONE,underline gui=NONE,undercurl
    hi ALEErrorSign ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi ALEWarningSign ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi ALEInfoSign ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi CtrlPMatch ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPNoEntries ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPPrtBase ctermfg=232 ctermbg=NONE guifg=#100a14 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPPrtCursor ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPLinePre ctermfg=232 ctermbg=NONE guifg=#100a14 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi CtrlPMode1 ctermfg=32 ctermbg=232 guifg=#67c7ff guibg=#100a14 guisp=NONE cterm=NONE gui=NONE
    hi CtrlPMode2 ctermfg=235 ctermbg=32 guifg=#282a36 guibg=#67c7ff guisp=NONE cterm=NONE gui=NONE
    hi CtrlPStats ctermfg=240 ctermbg=232 guifg=#5b5b5b guibg=#100a14 guisp=NONE cterm=NONE gui=NONE
    hi DirvishPathTail ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi DirvishArg ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link EasyMotionTarget Search
    hi! link EasyMotionShade Comment
    hi gitcommitSelectedFile ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi gitcommitDiscardedFile ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi GitGutterAdd ctermfg=70 ctermbg=235 guifg=#5af78e guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi GitGutterChange ctermfg=173 ctermbg=235 guifg=#e18254 guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi GitGutterDelete ctermfg=196 ctermbg=235 guifg=#ff5c57 guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi GitGutterChangeDelete ctermfg=168 ctermbg=235 guifg=#ff6ac1 guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    if get(g:, "indent_guides_auto_colors", 0)
      if get(g:, "waves_invert_indent_guides", 0)
    ...
    hi NERDTreeDir ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeDirSlash ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeOpenable ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeClosable ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeFile ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeExecFile ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeUp ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeCWD ctermfg=170 ctermbg=NONE guifg=#bc6ec5 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeHelp ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeToggleOn ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi NERDTreeToggleOff ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwDir ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwClassify ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwLink ctermfg=239 ctermbg=NONE guifg=#44505c guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwSymLink ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwExe ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwComment ctermfg=239 ctermbg=NONE guifg=#44505c guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwList ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwHelpCmd ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwCmdSep ctermfg=243 ctermbg=NONE guifg=#727272 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi netrwVersion ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    " Rainbow Parentheses
    if !exists('g:rbpt_colorpairs')
      let g:rbpt_colorpairs = [['blue', '#46baff'], ['magenta', '#a15ea7'],
            \ ['red', '#d26487'], ['173', '#ca754b']]
    endif

    let g:rainbow_guifgs = [ '#ca754b', '#d26487', '#a15ea7', '#46baff' ]
    ...
    hi ShowMarksHLl ctermfg=32 ctermbg=235 guifg=#67c7ff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi ShowMarksHLu ctermfg=32 ctermbg=235 guifg=#67c7ff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi ShowMarksHLo ctermfg=32 ctermbg=235 guifg=#67c7ff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi ShowMarksHLm ctermfg=32 ctermbg=235 guifg=#67c7ff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi SignifySignAdd ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignifySignChange ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignifySignDelete ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi SignatureMarkText ctermfg=32 ctermbg=235 guifg=#67c7ff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    ...
    hi StartifyFile ctermfg=249 ctermbg=235 guifg=#ffffff guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi StartifyNumber ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifyPath ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifySlash ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi StartifySection ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi SyntasticError ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ff5c57 cterm=NONE,underline gui=NONE,undercurl
    hi SyntasticWarning ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#f7ff81 cterm=NONE,underline gui=NONE,undercurl
    hi SyntasticErrorSign ctermfg=196 ctermbg=235 guifg=#ff5c57 guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    hi SyntasticWarningSign ctermfg=136 ctermbg=235 guifg=#f7ff81 guibg=#282a36 guisp=NONE cterm=NONE gui=NONE
    ...
    hi WhichKeySeperator ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link WhichKeyGroup Keyword
    hi! link WhichKeyDesc Identifier
    let g:vimshell_escape_colors = [
          \ '#34323e', '#ff5c57', '#5af78e', '#f7ff81',
          \ '#67c7ff', '#bc6ec5', '#e6005f', '#5b5b5b',
          \ '#282a36', '#ff5c57', '#5af78e', '#e18254',
          \ '#67c7ff', '#bc6ec5', '#e6005f', '#cdcdcd'
          \ ]
  endif
  if get(g:, "waves_filetype_hi_groups", 1)
    hi diffAdded ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffRemoved ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffChanged ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffFile ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffNewFile ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi diffLine ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlTag ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlEndTag ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlTagName ctermfg=133 ctermbg=NONE guifg=#a45bad guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlArg ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlScriptTag ctermfg=170 ctermbg=NONE guifg=#bc6ec5 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlTagN ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlSpecialTagName ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi htmlLink ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE,underline gui=NONE,underline
    ...
    hi htmlItalic ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlTag ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlEndTag ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlTagName ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi xmlEqual ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi docbkKeyword ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi xmlAttrib ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi vimCommentTitle ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE,bold gui=NONE,bold
    ...
    hi vimCommand ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi vimLet ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi vimNorm ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link vimFuncSID Function
    hi! link vimFunction Function
    hi vimGroup ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi vimContinue ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureKeyword ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi clojureFunc ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureRepeat ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureCharacter ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureStringEscape ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureException ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureRegexp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureRegexpEscape ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi clojureAnonArg ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureVariable ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureMacro ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureMeta ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureDeref ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureQuote ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi clojureUnquote ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi rustSelf ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi rustPanic ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi rustAssert ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link pythonCoding Comment
    hi cssBraces ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssFunctionName ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssIdentifier ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssClassName ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssColor ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssSelectorOp ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssSelectorOp2 ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssImportant ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssVendor ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssTextProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssAnimationProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssUIProp ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssTransformProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssTransitionProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssPrintProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssPositioningProp ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssBoxProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssFontDescriptorProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssFlexibleBoxProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssBorderOutlineProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssBackgroundProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssMarginProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssListProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssTableProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssFontProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssPaddingProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssDimensionProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssRenderProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssColorProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi cssGeneratedContentProp ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptBraces ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptFunction ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptIdentifier ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaScriptMember ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javascriptImport ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptExport ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptClassKeyword ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptClassExtends ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDefault ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptClassName ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptClassSuperName ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptGlobal ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptEndColons ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptFuncArg ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptGlobalMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptNodeGlobal ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptBOMWindowProp ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptArrayMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptArrayStaticMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptCacheMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDateMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptMathStaticMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptURLUtilsProp ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptBOMNavigatorProp ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDOMDocMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDOMDocProp ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptBOMLocationMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptBOMWindowMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptStringMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javascriptFuncKeyword ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptAsyncFunc ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptClassStatic ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptOperator ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptForOperator ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptYield ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptExceptions ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptMessage ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptTemplateSB ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptTemplateSubstitution ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptLabel ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptObjectLabel ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptPropertyName ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptLogicSymbols ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptArrowFunc ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javascriptBrackets ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDOMElemAttrs ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDOMEventMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDOMNodeMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptDOMStorageMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptHeadersMethod ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptAsyncFuncKeyword ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javascriptAwaitFuncKeyword ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link jsClassKeyword Keyword
    hi! link jsExtendsKeyword Keyword
    hi jsExportDefault ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsTemplateBraces ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsParens ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsFunctionKey ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsFuncBraces ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsVariableDef ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi jsClassBlock ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsFutureKeys ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsFuncArgs ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsStorageClass ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsxRegion ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi typeScriptReserved ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link typeScriptLabel Label
    hi! link typeScriptFuncKeyword Function
    hi! link typeScriptIdentifier Identifier
    hi typeScriptBraces ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi typeScriptEndColons ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi typeScriptDOMObjects ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link typeScriptAjaxMethods Function
    hi typeScriptLogicSymbols ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link typeScriptDocSeeTag Comment
    hi! link typeScriptDocParam Comment
    hi! link typeScriptDocTags vimCommentTitle
    hi! link typeScriptGlobalObjects Keyword
    hi typeScriptParens ctermfg=68 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi typeScriptInterpolationDelimiter ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi purescriptModuleKeyword ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi purescriptModuleName ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi purescriptWhere ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi rubyStringDelimiter ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi rubyInterpolationDelimiter ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi objcTypeModifier ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi objcDirective ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi goDirective ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi goDeclType ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi goBuiltins ctermfg=173 ctermbg=NONE guifg=#e18254 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi luaIn ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi luaFunction ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi moonObject ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaAnnotation ctermfg=32 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi javaDocTags ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi javaVarArg ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link elixirDocString Comment
    hi elixirStringDelimiter ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi elixirInterpolationDelimiter ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi elixirModuleDeclaration ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaNameDefinition ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaCaseFollowing ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaCapitalWord ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaTypeExtension ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaKeyword ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaKeywordModifier ctermfg=168 ctermbg=NONE guifg=#ff6ac1 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaSpecial ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaOperator ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaTypeDeclaration ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaTypeTypePostDeclaration ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaInstanceDeclaration ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi scalaInterpolation ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownItalic ctermfg=243 ctermbg=NONE guifg=#727272 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH1 ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH2 ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH3 ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH4 ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH5 ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi markdownH6 ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi markdownCodeBlock ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi markdownUrlTitleDelimiter ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi! link markdownLinkText htmlLink
    hi! link markdownIdDeclaration markdownLinkText
    hi haskellType ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellIdentifier ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellSeparator ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellDelimiter ctermfg=240 ctermbg=NONE guifg=#5b5b5b guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellOperators ctermfg=32 ctermbg=NONE guifg=#67c7ff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi haskellLet ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellDefault ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellWhere ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellBottom ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellBlockKeywords ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellImportKeywords ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellDeclKeyword ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellDeriving ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellAssocType ctermfg=29 ctermbg=NONE guifg=#e6005f guibg=NONE guisp=NONE cterm=NONE gui=NONE
    ...
    hi haskellString ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi haskellChar ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsonKeyword ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsonQuote ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsonBraces ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
    hi jsonString ctermfg=249 ctermbg=NONE guifg=#ffffff guibg=NONE guisp=NONE cterm=NONE gui=NONE
  endif
  finish
endif

let g:terminal_ansi_colors = [
      \ '#fbf8ef', '#d26487', '#4be67e', '#f3f99d', '#46baff', '#a15ea7', '#49C773', '#504259',
      \ '#a8a4ae', '#ff5c57', '#5af78e', '#f7ff81', '#3a81c3', '#6c3163', '#24775c', '#655370']
if !has('gui_running') && get(g:, 'waves_transp_bg', 0)
...
hi DiffAdd ctermfg=70 ctermbg=231 guifg=#5af78e guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffChange ctermfg=166 ctermbg=231 guifg=#b46843 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffDelete ctermfg=196 ctermbg=231 guifg=#ff5c57 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi DiffText ctermfg=136 ctermbg=231 guifg=#f7ff81 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi Error ctermfg=196 ctermbg=231 guifg=#ff5c57 guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
hi ErrorMsg ctermfg=231 ctermbg=196 guifg=#fbf8ef guibg=#ff5c57 guisp=NONE cterm=NONE gui=NONE
...
hi! link QuickFixLine Search
hi! link qfLineNr Type
hi Search ctermfg=70 ctermbg=231 guifg=#5af78e guibg=#fbf8ef guisp=NONE cterm=NONE,reverse gui=NONE,reverse
...
hi! link StatusLineTerm StatusLine
hi TabLineSel ctermfg=70 ctermbg=255 guifg=#5af78e guibg=#efeae9 guisp=NONE cterm=NONE gui=NONE
hi! link TabLine TabLineFill
hi Title ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
"hi Function ctermfg=89 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
hi StorageClass ctermfg=136 ctermbg=NONE guifg=#f7ff81 guibg=NONE guisp=NONE cterm=NONE gui=NONE
hi Special ctermfg=172 ctermbg=NONE guifg=#d79650 guibg=NONE guisp=NONE cterm=NONE gui=NONE
...
if get(g:, "waves_plugin_hi_groups", 1)
  ...
  hi gitcommitSelectedFile ctermfg=70 ctermbg=NONE guifg=#5af78e guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi gitcommitDiscardedFile ctermfg=196 ctermbg=NONE guifg=#ff5c57 guibg=NONE guisp=NONE cterm=NONE gui=NONE
  hi GitGutterAdd ctermfg=70 ctermbg=231 guifg=#5af78e guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi GitGutterChange ctermfg=166 ctermbg=231 guifg=#b46843 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi GitGutterDelete ctermfg=196 ctermbg=231 guifg=#ff5c57 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  ...
  hi SyntasticError ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#ff5c57 cterm=NONE,underline gui=NONE,undercurl
  hi SyntasticWarning ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=#f7ff81 cterm=NONE,underline gui=NONE,undercurl
  hi SyntasticErrorSign ctermfg=196 ctermbg=231 guifg=#ff5c57 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi SyntasticWarningSign ctermfg=136 ctermbg=231 guifg=#f7ff81 guibg=#fbf8ef guisp=NONE cterm=NONE gui=NONE
  hi multiple_cursors_cursor ctermfg=NONE ctermbg=NONE guifg=NONE guibg=NONE guisp=NONE cterm=NONE,reverse gui=NONE,reverse
  ...
  hi! link WhichKeyDesc Identifier
  let g:vimshell_escape_colors = [
        \ '#a8a4ae', '#ff5c57', '#5af78e', '#f7ff81',
        \ '#3a81c3', '#6c3163', '#24775c', '#463a4e',
        \ '#fbf8ef', '#ff5c57', '#5af78e', '#b46843',
...
" Color: neutralgreen      #4be67e    ~
" Color: neutralyellow     #f3f99d    ~
" Color: neutralblue       #46baff    ~
" Color: neutralpurple     #a15ea7    ~
" Color: neutralaqua       #49C773    ~
